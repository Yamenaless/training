    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-[#16335c] mb-4">Our Mission & Values</h2>
        ...
        {/* Mission Statement */}
        <div className="bg-[#16335c] rounded-lg p-8 md:p-12 mb-16 text-center shadow-xl">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {values.map((value, index) => (
            <div key={index} className="text-center p-6 rounded-lg bg-white border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
              <div className="flex justify-center mb-4">
                <div className="p-4 bg-[#16335c]/10 rounded-full">
                  <value.icon className="h-8 w-8 text-[#16335c]" />
                </div>
              </div>
              <h3 className="text-xl font-semibold text-[#16335c] mb-3">{value.title}</h3>
        ...
        <div className="mt-16 text-center">
          <h3 className="text-2xl md:text-3xl font-bold text-[#16335c] mb-6">Our Vision</h3>
