        ...
        <div className={`max-w-4xl mx-auto text-center transition-all duration-1000 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className="mb-8">
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed">
              Discover our comprehensive catalog of cutting-edge training programs designed to enhance your skills, 
              advance your career, and drive organizational success across all industries.
            </p>
          </div>
