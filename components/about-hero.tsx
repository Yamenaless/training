...
import { ChevronRight, Users, Globe, Award } from "lucide-react"
        ...
        <div className={`max-w-4xl mx-auto text-center transition-all duration-1000 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className="mb-8">
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed">
              Empowering professionals worldwide with cutting-edge training solutions that drive success, 
              innovation, and sustainable growth in today's dynamic business landscape.
            </p>
          </div>
